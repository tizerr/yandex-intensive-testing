    ...
    return <div className={bem()}>
        ...
        <nav className="navbar navbar-expand-sm navbar-light bg-light">
            <div className="container">
                <Link data-testid='home' className={bem('Brand', ['navbar-brand'])} to="/">Example store</Link>
                ...
                <div className={bem('Menu', [navbarClass])}>
                    <div className="navbar-nav">
                        <NavLink data-testid='catalog' className="nav-link test-link" activeClassName="active" to="/catalog" onClick={hide}>Catalog</NavLink>
                        ...
                        <NavLink data-testid='cartLabel' className="nav-link" activeClassName="active" to="/cart" onClick={hide}>{cartLabel}</NavLink>
                    </div>
                </div>
            </div>
        </nav>
